...
function DataframeTable({ data }) {
  ...
  const styles = {
    ...
    th: {
      ...
      color: theme.buttonText, // Changed from theme.primary to contrast with dark green
      padding: '12px 15px',
      textAlign: 'left',
    ...
    td: {
      ...
      color: theme.textPrimary, // Changed from textSecondary for better readability
    },
    tr: {
      '&:last-child td': {
        borderBottom: 'none',
